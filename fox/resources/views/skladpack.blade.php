...
@section('content')
    ...
    <h6><b>Адрес - {{ $operPoint->city->city_name }}, {{ $operPoint->point_address }} </b></h6>
        <hr>
        <h5><b>Принятые посылки на предотправную проверку/упаковку:</b></h5>
        <hr>
    <form action="{{route('skladPack')}}" method="get">
        ...
        <div class="text">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="packcheck[]" value="{{$package->id}}" id="exampleCheck1" style="margin-left: 5px">  Упаковка/проверка выполнена
                    </td>
                </tr>
            </table>
        </div>
